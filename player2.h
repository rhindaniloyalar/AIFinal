...
//the game
Move Player2::MakeMove(Move &m, board b)
{
...
void Player2::GetMyGamePieces(board game_board, unsigned short p)
{
	int index = 0;
...
void Player2::GetOpponentGamePieces(board game_board, unsigned short p)
{
	int index = 0;
...
Move Player2::RandomMove(Move &m, board game_board)
{
...
bool Player2::isValid(Move move, board game_board)
{
	short x, y;
	//board game_board;
	bool allclear;
...
//still buggy
bool Player2::IsBoxing(Move m, board b)
{
...
Move Player2::FourCornersBlock(Move &m, board b)
{
	for (int i = 0; i < 4; ++i)
	{
...
Move Player2::VerticalBlock(Move & m, board b)
{
...
//blocks opposing vertical win if possible
Move Player2::HorizontalBlock(Move & m, board b)
{
...
//???
Move Player2::ClusterBlock(Move & m, board b)
{
	return Move();
}

//???
bool Player2::IsClusterWin(Stone s, board b, Move &m)
{
...
bool Player2::IsHorizontalWin(Move & m, board b)
{
...
bool Player2::IsHorizontalLoss(Move m, board b)
{
	if (opposingPieces[0].y == opposingPieces[1].y == opposingPieces[2].y)
		return true;
	if (opposingPieces[0].y == opposingPieces[1].y == opposingPieces[3].y)
...
bool Player2::IsVerticalWin(Move & m, board b)
{
...
bool Player2::IsVerticalLoss(Move & m, board b)
{
	if (opposingPieces[0].x == opposingPieces[1].x == opposingPieces[2].x)
		return true;
	if (opposingPieces[0].x == opposingPieces[1].x == opposingPieces[3].x)
...
bool Player2::IsFourCornersWin(Move &m, board b)
{
...
bool Player2::IsFourCornersLoss(Move m, board b)
{
