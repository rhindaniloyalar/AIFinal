...
State::State()
{
	...
	//game_state.layout[1][3] = game_state.layout[2][0] = game_state.layout[2][2]
	//	= game_state.layout[3][1] = PLAYER1;
	//// Place player 2 stones.
	//game_state.layout[0][3] = game_state.layout[1][2] = game_state.layout[0][0]
